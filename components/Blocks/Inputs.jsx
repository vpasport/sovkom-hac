  ...
  return (
    ...
    >
      ...
      <Input
        typedefault="text"
        value={defaultInput}
        onChange={(e) => setDeafultInput(e.target.value)}
      ...
      <Input
        ...
        placeholder="Search..."
        description="Поиск чего-то важного"
      />
      ...
      />
      <Input disabled type="checkbox" text="Checkbox disabled" value />
      ...
      <Input
        type="dropdown"
        dropdownName="Dropdown pets list:"
        items={itemsDropdown}
        value=""
        onChange={() => {}}
      />
